...
public class Verify extends HttpServlet {
    ...
    {
        //String path = getServletContext().getRealPath("/logins.txt");
  
        
        String username = request.getParameter("username");
        String password = request.getParameter("password");
        
        // change this from being hard coded to file io
        if ((username.equals("admin") && password.equals("1234"))  ||
            (username.equals("burton") && password.equals("test")) ||
                username.equals("andrew") && password.equals("test"))
        {
